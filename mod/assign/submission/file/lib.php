...
function assignsubmission_file_pluginfile($course,
                                          ...
                                          $forcedownload) {
    global $DB, $CFG;
    require_once($CFG->dirroot . '/local/badgemaker/lib.php'); return local_badgemaker_assignsubmission_file_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload);
