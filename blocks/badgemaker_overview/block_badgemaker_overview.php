...
class block_badgemaker_overview extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_badgemaker_overview');
    }
    ...
    public function specialization() {
        if (empty($this->config->title)) {
            $this->title = get_string('title', 'block_badgemaker_overview');
        } else {
    ...
    public function get_content() {
        ...
        $this->content->text .= get_string('you_have_earned', 'block_badgemaker_overview') . ' <b>' . html_writer::link($myliburl, ''.$badgesAwardedCount) . "</b> " . get_string('badges', 'block_badgemaker_overview');

        $this->content->text .= "<hr><b>";
        $blurl = local_badgemaker_libraryAllPageURL();
        $this->content->text .= html_writer::link($blurl, ''.$issuedCount);
        $this->content->text .= "</b>" . get_string('awarded', 'block_badgemaker_overview');
        $this->content->text .= '<br>' . "<b>";
        $this->content->text .= html_writer::link($blurl, ''.$totalBadges);
        $this->content->text .= '</b>' . get_string('all_badges', 'block_badgemaker_overview');
        ...
        $this->content->text .= '<br>' . get_string('at', 'block_badgemaker_overview') . ' ' . $SITE->fullname;
